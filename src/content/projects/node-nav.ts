...
export default defineProject({
  slug: "node-nav",
  title: "node-nav",
  summary: "Explore dataset with interactive nodes",
  status: "prototype",
  categories: ["Web Development", "Useful Tools", "Experimental / Artistic"],
  thumbnail: "projects/node-nav/thumbnail.png",
  ...
  detail: {
    ...
    body: markdown`
      ...
      ![node-nav screenshot](screenshot.png)
    `,
  },
});
